<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="java.util.*" import="java.io.*" import="com.todaynic.client.mobile.*" import="com.todaynic.client.mobile.*" errorPage=""%>
<%   
      ...
      <tr>
        <td scope="row">
			<table width="90%" align="center" border="0" cellspacing="0" cellpadding="0">
			  <tr>
					<td bgcolor="#ECF4F8" class="text_blue14" align="center"><strong> = 接口模式演示程序使用说明  -短信用户余额查询- =</strong></td>
			  </tr>
			</table>
          <table width="90%"  border="1" align="center" cellpadding="1" cellspacing="0" bordercolorlight="#FFFFFF" bordercolor="#F5EEE8">
              <tr>
                <td width="16%" height="75" rowspan="4" bgcolor="#FFFFFF" scope="row"><font color="#000000">
              ...
              <tr>
                <td height="24" bgcolor="#FFFFFF" scope="row"><font color="#000000">
				  短信账户剩余：<%=recTable.get("smsaccount")%> 条<br>
                </font></td>
              </tr>
            </table>
              <table width="90%" align="center" border="0" cellspacing="0" cellpadding="0">
