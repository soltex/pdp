<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="java.io.*"  import="java.util.*" import="com.todaynic.client.mobile.*" errorPage=""%>
	...
	<tr>
		<td valign="top" style="padding:5px 5px 10px 10px;" bgcolor="#FFFFFF">
			...
			<table width="90%"  border="1" align="center" cellpadding="1" cellspacing="0" bordercolorlight="#FFFFFF" bordercolor="#F5EEE8">
				...
				<tr>
					<td height="23" bgcolor="#FFFFFF" scope="row"><font color="#000000"> 状态： <%=code%> </font></td>
				</tr>
				<tr>
					<td height="24" bgcolor="#FFFFFF" scope="row"> 信息：<font color="#000000"><%=recmsg%></font></td>
				</tr>
				<tr>
					<td height="24" bgcolor="#FFFFFF" scope="row"> <font color="#000000"> 是否成功：<%=recTable.get("smsstatus")%>&nbsp;&nbsp;&nbsp;&nbsp;[大于0为成功, 小于等于0为失败]<br>
						发送通道：<%=type%><br>
						短信发送成功号码：<%=recTable.get("successphone")%><br>
						</font></td>
				</tr>
			</table>
			<table width="90%" align="center" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<th height="29" align="left" scope="row"> 发送的XML信息如下： </th>
				</tr>
				<tr>
			...
			<table width="90%" align="center" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="29" align="center">
						...
						&nbsp;&nbsp;&nbsp;
						<input name="next" type="button" value="下一步，用户余额查询" onClick="location.href='smsaccount.jsp'" class="button_orange">
						&nbsp;&nbsp;&nbsp;
						<input name="next" type="button" value="重新配置文件" onClick="location.href='smsconf.jsp'" class="buttonback">
					</td>
				</tr>
			</table>
