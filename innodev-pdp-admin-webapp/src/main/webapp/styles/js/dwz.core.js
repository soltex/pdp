	...
	window.DWZ = {
		...
		ajaxDone:function(json, event){
			if(json[DWZ.keys.statusCode] == DWZ.statusCode.error) {
				if(json[DWZ.keys.message]) error(json[DWZ.keys.message]);//DWZ.alert.error(json[DWZ.keys.message]);
				...
				if(json[DWZ.keys.message]) success(json[DWZ.keys.message]);//DWZ.alert.success(json[DWZ.keys.message]);
